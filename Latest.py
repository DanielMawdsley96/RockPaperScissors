        ...
        while finished is False:
            def computer_move(): 
                ...
                if game == 0:
                    ...
                    if (history[-1] == history[-2] == history[-3]):
                    ...
                    elif (history[-1] == history[-2]) or result == outcome[2]: #player more likely to change with a loss or draw
                        n = 0
                        for choice in selection_list:
                            if choice == player_selection:
                                ...
                                n += 1
                    elif result == outcome[0]: #Player more likely to choice a winning choice twice 
                        move = cpu_list[player_selection]
